...
tags: ['next js', 'guide']
draft: false
summary: 'In this article we introduce adding images in the tailwind starter news and the benefits and limitations of the next/image component.'
authors: ['sparrowhawk']
---

# Introduction

The tailwind starter news has out of the box support for [Next.js's built-in image component](https://nextjs.org/docs/api-reference/next/image) and automatically swaps out default image tags in markdown or mdx documents to use the Image component provided.
