---
title: 'Introducing Tailwind Nextjs Starter News'
date: '2021-01-12'
lastmod: '2024-08-16'
...
> [!CAUTION]
> This is the README of version 1 of the template. It is kept for historical reasons, but is no longer supported. It also serves as a nice example of [Github Alert](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax#alerts). For the actual documentation, please refer to the [Github repository](https://github.com/timlrx/tailwind-nextjs-starter-news).

This is a [Next.js](https://nextjs.org/), [Tailwind CSS](https://tailwindcss.com/) newsging starter template. Probably the most feature-rich Next.js markdown newsging template out there. Comes out of the box configured with the latest technologies to make technical writing a breeze. Easily configurable and customizable. Perfect as a replacement to existing Jekyll and Hugo individual news.
...
1. JS (official support) - `npx degit https://github.com/timlrx/tailwind-nextjs-starter-news.git` or TS (community support) - `npx degit timlrx/tailwind-nextjs-starter-news#typescript`
